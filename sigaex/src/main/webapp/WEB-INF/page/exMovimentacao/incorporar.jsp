...
<siga:pagina titulo="Incorporar Documento">
	...
	<div class="gt-bd clearfix">
		<div class="gt-content clearfix">
			...
			<h2>
				Incorporação de Documento - ${mob.siglaEDescricaoCompleta}
			</h2>
					...
					<td>
						<siga:escolha id="idDocumentoEscolha" var="idDocumentoEscolha">
							<siga:opcao id='1' texto="Documento Interno" >
								<siga:selecao tema='simple'  titulo="Documento Pai:" propriedade="documentoRef" urlAcao="buscar" 
									urlSelecionar="selecionar" modulo="sigaex" paramList="tipo_operacao=incorporacao;primeiraVez=sim"/>
							</siga:opcao>
